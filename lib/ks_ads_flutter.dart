...
class KsAdsFlutter {
  static const MethodChannel _channel = const MethodChannel('ks_ads_flutter');
  static const EventChannel adEventEvent =
      const EventChannel("com.ahd.ks_ads/ad_event");
